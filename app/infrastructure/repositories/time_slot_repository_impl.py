...
from app.infrastructure.models import TimeSlotModel, AppointmentModel
...
class TimeSlotRepositoryImpl(TimeSlotRepository):
    ...
    def get_slots_by_doctor_and_date_range(self, doctor_id, start_date, end_date):
        return db.session.query(TimeSlotModel) \
